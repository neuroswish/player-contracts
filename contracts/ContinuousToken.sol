...
contract ContinuousToken is BondingCurve, ReentrancyGuardUpgradeable {
    ...
    //TODO define initial supply
    uint256 public initialSupply;
    uint256 public totalSupply;
    uint8 public decimals;
    uint32 public reserveRatio; // reserve ratio
    ...
    mapping(address => uint256) private balance; // mapping of a user address to the user's token balance
